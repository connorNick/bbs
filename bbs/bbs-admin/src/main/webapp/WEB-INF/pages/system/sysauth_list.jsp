            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="alert-info fade in">
                        <button type="button" class="btn btn-primary m-l-20 m-t-10 m-b-10" onclick="toadd('menu')">新增菜单</button>
                        <button type="button" class="btn btn-primary m-l-20 m-t-10 m-b-10" onclick="toadd('button')">新增按钮</button>
                    </div>
                    <div class="panel-body">
                        <div class="table-responsive">
                            ...
                            <input type="text" class="form-control" id="gadname" placeholder="查询条件：资源名称" style="position: relative;width: 200px;top: 22px;">
...
<script>
    ...
    //去往编辑页面
    function toedit(id){
        window.location.href="<%=path%>/sysauth/toedit/"+id;
    }

    //去往新增页面
    function toadd(type){
        window.location.href="<%=path%>/sysauth/toadd/"+type;
    }
